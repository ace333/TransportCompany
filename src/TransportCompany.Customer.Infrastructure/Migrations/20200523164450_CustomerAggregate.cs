        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverDetails_PhoneNumber = table.Column<string>(maxLength: 64, nullable: true),
                    DriverDetails_CarModel = table.Column<string>(maxLength: 64, nullable: true),
                    DriverDetails_CarRegistrationPlateNumber = table.Column<string>(maxLength: 64, nullable: true),
